...
@WebServlet("/QueryByAnswering")
public class QueryByAnswering extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryByAnswering() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		ArrayList<LeiXinTj> leiXinTjs=queryFromMySql.QueryByAnswering();
